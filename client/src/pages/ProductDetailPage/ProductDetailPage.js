...
export default function ProductPage() {
  const [activeImage, setActiveImage] = useState('https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/m/a/macbook_4__7.png');
  ...
  const colors = [
    { id: 0, name: 'Ánh sao', price: '23.990.000đ', img: 'https://cdn2.cellphones.com.vn/insecure/rs:fill:50:50/q:90/plain/https://cellphones.com.vn/media/catalog/product/t/e/text_ng_n_15__7_163.png' },
    { id: 1, name: 'Đêm xanh thẳm', price: '23.990.000đ', img: 'https://cdn2.cellphones.com.vn/insecure/rs:fill:50:50/q:90/plain/https://cellphones.com.vn/media/catalog/product/t/e/text_ng_n_16__6_123.png' },
    { id: 2, name: 'Bạc', price: '23.990.000đ', img: 'https://cdn2.cellphones.com.vn/insecure/rs:fill:50:50/q:90/plain/https://cellphones.com.vn/media/catalog/product/t/e/text_ng_n_14__8_17.png' },
    { id: 3, name: 'Xanh da trời', price: '23.990.000đ', img: 'https://cdn2.cellphones.com.vn/insecure/rs:fill:50:50/q:90/plain/https://cellphones.com.vn/media/catalog/product/t/e/text_ng_n_13__7_16.png' },
  ];
  ...
  return (
    <div className="product-page">
      ...
      <div className="breadcrumb container">
        <span>Trang chủ</span> ❯ <span>Laptop</span> ❯ <span>Mac</span> ❯ <span>Macbook M4</span> ❯ <strong className="text-dark">MacBook Air M4 13 inch 2025 10CPU 8GPU 16GB 256GB | Chính hãng Apple Việt Nam</strong>
      </div>
      ...
      <main className="main-content container">
        ...
        <div className="right-column product-card">
          ...
          <div className="action-buttons">
            ...
            <button className="btn-add-cart" title="Thêm vào giỏ hàng">🛒</button>
          </div>
        </div>
      </main>
      ...
      <section className="reviews-section container">
        <div className="product-card">
          <h3 className="reviews-title">Đánh giá MacBook Air M4 13 inch 2025</h3>
                ...
                {[5, 4, 3, 2, 1].map((star, index) => (
                  <div key={index} className="star-row">
                    ...
                    <div className="progress-bar">
                      <div className="progress-fill" style={{ width: star === 5 ? '90%' : star === 4 ? '10%' : '0%' }}></div>
                    </div>
                  </div>
                ))}
              </div>
